...
export default function Section3() {
  return (
    <div id="Projects" className="section3_container">
      <div className="section3_inner">
        <h2 className="s3_h2">
          Sites & <span style={{ color: "#6d28d9" }}>Projects</span>
        </h2>
        <h4 className="s3_h4">Projects that I worked on</h4>
        <div className="s3_grid_items">
          <div className="s3_grid_item item1">
            <div className="s3_grid_item_inner">
          ...
          <div className="s3_grid_item item2">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>ACBA</h4>
          ...
          <div className="s3_grid_item item3">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>Money Compass</h4>
          ...
          <div className="s3_grid_item item4">
            <div className="s3_grid_item_inner">
              <div className="project_details">
          ...
          <div className="s3_grid_item item5">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>MC NFT</h4>
                <p>NFT showcase platform</p>
          ...
          <div className="s3_grid_item item6">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>MMA</h4>
          ...
          <div className="s3_grid_item item7">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>UNIEC</h4>
          ...
          <div className="s3_grid_item item8">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>UNIEC Sponsor</h4>
          ...
          <div className="s3_grid_item item9">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>MyJOBFY</h4>
          ...
          <div className="s3_grid_item item10">
            <div className="s3_grid_item_inner">
              <div className="project_details">
                <h4>uLearnMoney</h4>
